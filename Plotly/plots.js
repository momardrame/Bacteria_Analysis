      ...
      var gauge_trace = [
        {
          ...
          gauge: {
            ...
            bar: { color: "steelblue" },
            steps: [
              { range: [0, 1], color: 'rgba(150, 0, 0, 0.1)' },
              { range: [1, 2], color: 'rgba(150, 0, 0, 0.1)' },
              { range: [2, 3], color: 'rgba(150, 0, 0, 0.2)' },
              { range: [3, 4], color: 'rgba(110, 154, 22, .2)' },
              { range: [4, 5], color: 'rgba(110, 154, 22, .3)' },
              { range: [5, 6], color: 'rgba(110, 154, 22, .5)' },
              { range: [6, 7], color: 'rgba(25, 154, 0, .5)' },
              { range: [7, 8], color: 'rgba(14, 127, 0, .5)' },
              { range: [8, 9], color: 'rgba(25, 154, 0, .6)' },
              { range: [9, 10], color: 'rgba(25, 154, 0, .7)' }
